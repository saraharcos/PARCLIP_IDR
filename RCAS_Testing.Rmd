...
So RCAS can't be installed because the R version is wrong, but I can't figure out how to update R on AWS. Temporary solution is to create necessary files, then scp them to my local machine. 
...
df1_idr <- calc_IDR(r2_bw3, r3_bw3, "ModeScore", gap = 1)

#plot
plot_cutoff(df1_idr, 0.25)
print(paste("Number of clusters in rep 1:", n_distinct(r2_bw3)))
print(paste("Number of clusters in rep 2:", n_distinct(r3_bw3)))
print(paste("Number of overlapping clusters:", n_distinct(df1_idr)))
print(paste("Number of clusters passing idr threshold:", n_distinct(df1_idr %>% filter(idr < 0.25))))
```

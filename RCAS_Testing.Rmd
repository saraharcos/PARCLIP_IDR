...
r_fracs <- readRDS("data/r2_r3_overlaps.rda")

idr_mc <- readRDS("data/idr_summ_T2Cfraction_MC1000")

m6A <- read_tsv("data/m6A_peaks_hg19.bed", col_names = FALSE)
```

# Plot the distribution and the 95% Confidence Interval
```{r}
